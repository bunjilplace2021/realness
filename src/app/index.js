...
// GLOBAL VARIABLES
import {getContext, Context, FMOscillator, Filter, Noise, setContext, start} from 'tone';

// UTILITIES
import {fetchSample, mapValue, resampleBuffer, soundLog, safariFallback, randomChoice} from './utilityFunctions';
...
const loadFallback = async () => {
	if (typeof fallBack == 'undefined') {
		import(/* webpackChunkName:"fallback" */ './samples/fallback.mp3').then((file) => {
